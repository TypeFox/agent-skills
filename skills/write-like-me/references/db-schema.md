...
| `evidence[]` | verbatim quotes with their document id. Required for presence patterns; `validate --corpus-dir` checks each quote appears in its source. Absence patterns carry none — their evidence is the zero counts |
